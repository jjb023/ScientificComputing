...
def find_time_period(func, A, B, X0, t_span=(0, 200), t_eval_resolution=20000001, slice_indices=(10000000, 14000001), round_precision=3):
    """
    ...
    sol = solve_ivp(lambda t, X: func(X, t, {'a': A, 'b': B}), t_span, X0, t_eval=t_eval)
