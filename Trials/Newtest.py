import unittest
import numpy as np
from New import predator_prey, phase_condition, RK4, solve_ode, shooting
...
class TestNewMethods(unittest.TestCase):
    ...
    def test_shooting(self):
        ...
        phase_condition_func = phase_condition
        initial_conditions = np.array([1.0, 1.0, 1.0])
        params = (1.0, 1.0, 1.0)

        # Call function
        shooting_func = shooting(function, phase_condition_func)
        result = shooting_func(initial_conditions, params)
