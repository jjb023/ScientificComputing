...
ode = lambda t, u: morris_lecar(t, u, 30)

# Some orbits
(t,u) = orbit(ode, (0,0), 100)
pyplot.plot(u[0,:], u[1,:], "b-")
(t,u) = orbit(ode, (-20,0), 100)
pyplot.plot(u[0,:], u[1,:], "b-")
(t,u) = orbit(ode, (20,0), 100)
pyplot.plot(u[0,:], u[1,:], "b-")
(t,u) = orbit(ode, (0,0.5), 100)
pyplot.plot(u[0,:], u[1,:], "b-")
(t,u) = orbit(ode, (0,1.0), 100)
pyplot.plot(u[0,:], u[1,:], "b-")

# V nullcline
(Vval, Nval) = nullcline(ode, (-60, 20), index=0)
pyplot.plot(Vval, Nval, "r-")

# N nullcline
(Vval, Nval) = nullcline(ode, (-60,20), index=1)
pyplot.plot(Vval, Nval, "g-")

# Equilibria
result = equilibrium(ode, (-40, 0))
pyplot.plot(result[0], result[1], "k.")
result = equilibrium(ode, (-20, 0))
pyplot.plot(result[0], result[1], "k.")
result = equilibrium(ode, (5, 0.3))
pyplot.plot(result[0], result[1], "k.")
